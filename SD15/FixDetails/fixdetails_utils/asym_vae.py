...
# from diffusers.models.autoencoders.vae import DecoderOutput, DiagonalGaussianDistribution, Encoder, MaskConditionDecoder
from diffusers.models.autoencoders.vae import DecoderOutput, DiagonalGaussianDistribution, Encoder
from .mask_condition_decoder import MaskConditionDecoder
...
class AsymmetricAutoencoderKL(ModelMixin, ConfigMixin):
    ...
    def decode(
        ...
        decoded = self._decode(z, image=image, mask=mask).sample
    ...
    def forward(
        ...
        if sample_posterior:
            ...
            z = posterior.mode()
        dec = self.decode(z, image=condition, mask=mask).sample
