...
from .resampler import Resampler, PositionResampler
...
class IPAdapter:
    def __init__(self, sd_pipe, image_encoder_path, ip_ckpt, device, num_tokens=16):
        self.device = device
...
class IPAdapterPlus(IPAdapter):
    ...
    def init_proj(self):
        image_proj_model = PositionResampler(
